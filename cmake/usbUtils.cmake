...
function(usb_get_device_lib_files libSourceList libHeaderList)
    ...
    elseif(${MCU_NAME} MATCHES "^STM32.+$")
        if(${MCU_NAME} MATCHES "^STM32(G4.+|F04.+|F07[028].+|F10[23].+|F30[23].[BC]|F30[23].[68DE]2?|F373.+|L0.[23].+|L1.+|L4.[23].+)$")
...
macro(usb_generate_config fileDestination fileList)
    ...
    if (${extra_count} GREATER 0)
        ...
        elseif(${MCU_NAME} MATCHES "^STM32[GL]4.+")
...
function(usb_set_init_sequence file_path)
    ...
    if(${MCU_NAME} MATCHES "^STM32.+")
        ...
        elseif(${MCU_NAME} MATCHES "^STM32(F3(02.[68BCDE]|03.[BCDE]|7[23].+)|G4.+)")
...
function(check_usb_components has_usb has_usb_interrupts usb_list)
    ...
    if(${MCU_NAME} MATCHES "^STM32.+")
        if ((${MCU_NAME} MATCHES "^STM32((G4.+|L0.[23]|F0[47][028]|F[24].[1235679]|F10[57]|F7.[235679]|L4[1-9A][2-9]|L4[PQRS][579]|F373|F10[23]|L1).+|F30(2.[68BCDE]|3.[BCDE]))"))
